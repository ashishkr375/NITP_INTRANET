...
export default function Page() {  
    ...
    return(
        <div>
            <div className="my-10  flex space-x-1 overflow-x-auto ">
            ...
            <div className="max-sm:mx-1 max-md:mx-8 mx-20 border p-4 rounded-md shadow-lg shadow-slate-400 backdrop-blur-md text-xs md:text-base">
                {/* LINKS */}
                <div className="mb-10 text-black overflow-x-auto">
                    <div className="w-[720px] md:w-[1250px]">
