...
const Footer = () => {
  ...
  <footer className="fsdiv bg-[#421010] text-white">
      
      <div className="container3 mx-auto px-4 border-t gap-5 py-1 md:py-4 flex justify-between items-center text-[0.5rem] md:text-sm">
        <p>
